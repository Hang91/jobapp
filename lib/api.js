...
module.exports = {
	...
	find(data={}, fields=null, options={}) {
		return new Promise((resolve, reject) => {
			...
			EventDB.find(data, fields, options, (error, doc) => {
				if(error){
					reject(error);
				}else{
					resolve(doc)
	...
	findOne(data) {
		return new Promise((resolve, reject) => {
			...
			EventDB.findOne(data, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	findById(data) {
		return new Promise((resolve, reject) => {
			...
			EventDB.findById(data, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	update(conditions, update) {
		return new Promise((resolve, reject) => {
			...
			EventDB.update(conditions, update, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
	...
	remove(conditions) {
		return new Promise((resolve, reject) => {
			...
			EventDB.remove(conditions, (error, doc) => {
				if(error){
					reject(error)
				}else{
					resolve(doc)
